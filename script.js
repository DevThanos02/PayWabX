...
function handlePay() {
    ...
    setTimeout(() => {
        window.location.href = "upi://pay?pa=DevThanos02@UPI&pn=Dev%20Thanos02&mc=0000&mode=02&purpose=00"; // Replace upi id and name keep the format same
    }, 3000);
}
...
const paymentAddresses = {
    paypal: 'https://paypal.me/', // Update Paypal value
    binance: '486968757', // Update Binance Pay value
    coffee: 'https://buymeacoffee.com/DevThanos02' // Update Buy me coffe value
};
